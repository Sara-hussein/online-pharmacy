      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="text">
              <h2>Free Shipping</h2>
              <p>It's All About Your Comfort.</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="text">
              ...
              <p>We Are Here For You EveryTime.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                ...
                <div class="block-38-body">
                  <p>CEO/Co-Founder And TeamLeader </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-6 mb-5">
            <div class="block-38 text-center">
              <div class="block-38-img">
                ...
                <div class="block-38-body">
                  <p> Marketing And Bussines Manager </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-6 mb-5">
            <div class="block-38 text-center">
              <div class="block-38-img">
                ...
                <div class="block-38-body">
                  <p> Social Media Specialist Assistant </p>
                </div>
              </div>
            </div>
          </div>
